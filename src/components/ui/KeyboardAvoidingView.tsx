...
import { useTheme, useAnimations, useSpacing } from '../theme/ThemeProvider';
...
export const KeyboardAvoidingView: React.FC<KeyboardAvoidingViewProps> = ({
  ...
  const animateKeyboard = useCallback((
    toHeight: number,
    duration: number = animationDuration || animations.duration.normal,
    easingName: string = animationEasing || animations.easing.easeInOut
  ) => {
