...
import { useTheme, useColors, useTypography, useSpacing, useRadius } from '../theme/ThemeProvider';
...
export const Heading = forwardRef<View, HeadingProps>(({
  ...
  const spacing_tokens = useSpacing();
  ...
  const textStyles = useMemo(() => {
    const baseStyle: TextStyle = {
      ...
      color: colors.interactive[variantConfig.colorKey],
    };
  ...
  const renderDecoration = () => {
    ...
    const accentColor = colors.semantic.critical; // Vibrant orange for accents
  ...
  const renderBadge = () => {
    ...
    return (
      <View
        style={[
          {
            backgroundColor: badgeColor || colors.semantic.critical,
