...
export const ValidationMessage: React.FC<ValidationMessageProps> = ({
  ...
  const stateConfig = useMemo(() => {
    const configs = {
      ...
      invalid: {
        ...
        borderColor: `${colors.accent.critical}30`,
        icon: '❌',
        animation: false,
      },
      warning: {
  ...
  const textStyles = useMemo(() => {
    const baseStyle: TextStyle = {
      fontSize: compact ? typography.scale.caption.fontSize : typography.scale.body.fontSize,
      lineHeight: compact ? typography.scale.caption.lineHeight : typography.scale.body.lineHeight,
      fontFamily: persianText ? typography.families.primary : typography.families.primary,
      color: typeConfig.color as string,
    ...
    return (
      ...
      >
        <Animated.View
          style={{
            height: '100%',
            backgroundColor: typeConfig.color as string,
            borderRadius: 1,
  ...
  // Fix for ValidationMessage.tsx - Replace the renderRules function (around line 450-520)
    ...
    >
      ...
      {rules.map((rule) => (
        ...
        >
          <Text
            style={{
              color: rule.valid ? colors.accent.success : colors.interactive.text.secondary,
              fontSize: 12,
              marginRight: rtl ? 0 : spacing.xs,
              marginLeft: rtl ? spacing.xs : 0,
            }}
          ...
          <Text
            style={{
              ...typography.scale.caption,
              color: rule.valid ? colors.interactive.text.primary : colors.interactive.text.secondary,
              textAlign: rtl ? 'right' : 'left',
              flex: 1,
            }}
          >
